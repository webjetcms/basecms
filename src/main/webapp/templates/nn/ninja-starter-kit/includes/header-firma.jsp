...
<nav class="c-main-navigation__main">
    <ul>
        ...
        <li class="c-main-navigation__menu">
            <iwcm:write>!INCLUDE(/components/menu/menu_ul_li.jsp, rootGroupId=106, startOffset=0, maxLevel=2, menuIncludePerex=false, classes=basic, generateEmptySpan=false, openAllItems=true, onlySetVariables=false, rootUlId=menu, menuInfoDirName=)!</iwcm:write>
        </li>
